...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapState"])({
    activeChainId: function activeChainId(state) {
      return state.navigation.activeAccount.chainId;
    }
  }), {
  ...
  watch: {
    'activeChainId': function activeChainId() {
      this.status = 'load';
      this.updateStatus();
    }
  },
  methods: {
    updateStatus: function updateStatus() {
      ...
      Object(_utils_promisify__WEBPACK_IMPORTED_MODULE_0__["promisifySimple"])(this.$background.getBlockchainStatus)({
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./src/vue/components/PermissionRequest.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/vue/components/PermissionRequest.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    enter: function enter(element) {
      ...
      console.log('enter', this.prevWidth); // eslint-disable-next-line no-param-reassign

      element.style.height = this.prevHeight;
      element.style.width = this.prevWidth;
      setTimeout(function () {// eslint-disable-next-line no-param-reassign
...
/* harmony import */ var _herajs_client__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @herajs/client */ "./node_modules/@herajs/client/dist/herajs.js");
/* harmony import */ var _herajs_client__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_herajs_client__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    '$route.params.address': function $routeParamsAddress() {
      this.loadState();
    }
  },
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_3__["mapState"])({
    requestType: function requestType(state) {
      return state.navigation.activeRequest && state.navigation.activeRequest.request ? state.navigation.activeRequest.request.type : '';
    }
  })),
  methods: {
    formatAmount: function formatAmount(amount) {
      return new _herajs_client__WEBPACK_IMPORTED_MODULE_2__["Amount"](amount).toUnit('aergo').toString();
    },
    loadState: function () {
...
/* harmony import */ var _utils_promisify__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../utils/promisify */ "./src/utils/promisify.js");
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { _defineProperty(target, key, source[key]); }); } return target; }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    Object(_utils_promisify__WEBPACK_IMPORTED_MODULE_4__["promisifySimple"])(this.$background.isUnlocked)().then(function (unlocked) {
      console.log('unlocked', unlocked);
  ...
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapState"])({
    accounts: function accounts(state) {
      ...
      items.sort(function (a, b) {
        return !a.data ? 0 : a.data.spec.chainId.localeCompare(b.data.spec.chainId);
      });
      return items;
    }
  }), {
    accountsByChainId: function accountsByChainId() {
      var result = groupBy(this.accounts, function (item) {
        return !item || !item.data ? '' : item.data.spec.chainId;
      });
      return Array.from(result);
    }
  }),
  methods: {
    explorerUrl: function explorerUrl(account) {
      return Object(_controllers_chain_provider__WEBPACK_IMPORTED_MODULE_1__["chainProvider"])(account.data.spec.chainId).explorerUrl("/account/".concat(account.data.spec.address));
    },
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/ApiTxSend.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/vue/pages/ApiTxSend.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _controllers_chain_provider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../controllers/chain-provider */ "./src/controllers/chain-provider.js");
/* harmony import */ var _components_PermissionRequest__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/PermissionRequest */ "./src/vue/components/PermissionRequest.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_8__["mapState"])({
    request: function request(state) {
      return state.navigation.activeRequest ? state.navigation.activeRequest : {};
    },
    txData: function txData(state) {
      return state.navigation.activeRequest && state.navigation.activeRequest.request ? state.navigation.activeRequest.request.data : {};
    }
  }), {
    ...
    explorerLink: function explorerLink() {
      return Object(_controllers_chain_provider__WEBPACK_IMPORTED_MODULE_6__["chainProvider"])(this.signedTx.chainId).explorerUrl("/transaction/".concat(this.lastTxHash));
    },
    payloadParsed: function payloadParsed() {
      var txData = this.txData;
    ...
    payloadDisplay: function payloadDisplay() {
      var txData = this.txData;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                this.error = '';
                this.status = 'sending';
                txData = _objectSpread({}, this.txData);
              ...
              case 8:
                ...
                _context.next = 13;
                return Object(_utils_promisify__WEBPACK_IMPORTED_MODULE_1__["promisifySimple"])(this.$background.respondToPermissionRequest)({
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return Object(_utils_promisify__WEBPACK_IMPORTED_MODULE_1__["promisifySimple"])(this.$background.denyPermissionRequest)(this.request.requestId);
  ...
  components: {
    ...
    PermissionRequest: _components_PermissionRequest__WEBPACK_IMPORTED_MODULE_7__["default"]
  }
});
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/ApiTxSign.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/vue/pages/ApiTxSign.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 8;
                return Object(timed_async__WEBPACK_IMPORTED_MODULE_4__["timedAsync"])(function () {
                  return Object(_utils_promisify__WEBPACK_IMPORTED_MODULE_1__["promisifySimple"])(_this.$background.signTransaction)(_this.signedTx, _this.signedTx.chainId);
                }, {
                  fastTime: 1000,
                  slowTime: 5000,
                  slow: function slow() {
              ...
              case 8:
                ...
                if ('tx' in result) {
                  this.lastTxSignature = result.tx.signature;
                  console.log('tx signed', this.lastTxSignature, this.signedTx);
                  this.status = 'success';
                } else if ('error' in result) {
                  this.error = result.error;
                  this.status = 'error';
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      selection: _controllers_chain_provider__WEBPACK_IMPORTED_MODULE_0__["DEFAULT_CHAIN"],
      chainId: '',
      state: 'initial',
      newAccount: {},
      error: ''
  ...
  watch: {
    'selection': function () {
      var _selection = _asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                chainId = prompt('Please enter the Chain ID');
                ...
                this.selection = _controllers_chain_provider__WEBPACK_IMPORTED_MODULE_0__["DEFAULT_CHAIN"];
                return _context.abrupt("return");

              case 5:
                ;
                nodeUrl = prompt('Please enter the node URL (e.g. http://127.0.0.1:7845)');
              ...
              case 10:
                ;
                _context.next = 13;
                return this.$store.dispatch('accounts/addNetwork', {
                  chainId: chainId,
                  nodeUrl: nodeUrl
                });
  ...
  methods: {
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 3:
                this.newAccount = _context2.sent;
    ...
    gotoAccount: function gotoAccount() {
      var id = encodeURIComponent("".concat(this.chainId, "/").concat(this.newAccount.address));
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/GetPublic.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/vue/pages/GetPublic.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var timed_async__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! timed-async */ "./node_modules/timed-async/index.js");
/* harmony import */ var _components_PermissionRequest__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/PermissionRequest */ "./src/vue/components/PermissionRequest.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    PermissionRequest: _components_PermissionRequest__WEBPACK_IMPORTED_MODULE_3__["default"]
  },
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return Object(_utils_promisify__WEBPACK_IMPORTED_MODULE_0__["promisifySimple"])(this.$background.respondToPermissionRequest)({
                  requestId: this.request.requestId,
                  result: {
                    account: account
                  }
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return Object(_utils_promisify__WEBPACK_IMPORTED_MODULE_0__["promisifySimple"])(this.$background.denyPermissionRequest)(this.request.requestId);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    explorerLink: function explorerLink(tx) {
      return Object(_controllers_chain_provider__WEBPACK_IMPORTED_MODULE_1__["chainProvider"])(tx.data.chainId).explorerUrl("/transaction/".concat(tx.data.hash));
    },
    reload: function () {
...
/* harmony import */ var _herajs_crypto__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @herajs/crypto */ "../herajs/packages/crypto/dist/herajs-crypto.umd.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      keyType: '',
      importedAddress: '',
      selection: _controllers_chain_provider__WEBPACK_IMPORTED_MODULE_3__["DEFAULT_CHAIN"],
      chainId: ''
    };
  },
  created: function created() {},
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                this.selection = _controllers_chain_provider__WEBPACK_IMPORTED_MODULE_3__["DEFAULT_CHAIN"];
                return _context.abrupt("return");
  ...
  methods: {
    importAccount: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee2() {
        var encryptedBytes, decryptedBytes, result;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
    ...
    gotoAccount: function gotoAccount() {
      var id = encodeURIComponent("".concat(this.chainId, "/").concat(this.importedAddress));
      this.$router.push("/account/".concat(id, "/"));
    },
    cancel: function cancel() {
      this.$router.push('/');
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                _context.next = 5;
                return Object(_utils_promisify__WEBPACK_IMPORTED_MODULE_1__["promisifySimple"])(this.$background.removeAccount)({
                  chainId: this.chainId,
                  address: this.address
                });
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    'transaction.to': function transactionTo(to) {
      ...
      if (to === 'aergo.name') {
        ...
        if (this.stakedAmount === '...') {
          Object(_utils_promisify__WEBPACK_IMPORTED_MODULE_1__["promisifySimple"])(this.$background.getStaking)({
            chainId: this.chainId,
            address: this.address
          }).then(function (result) {
            if (result.amount) {
              _this.stakedAmount = new _herajs_client__WEBPACK_IMPORTED_MODULE_0__["Amount"](result.amount).toUnit('aergo').toString();
            }
          });
        }
  ...
  methods: {
    ...
    startConfirm: function () {
      ...
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee() {
        var jsonPayload, amount, stringPayload, payload, type, jsonData, _jsonData, tx;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                stringPayload = this.transaction.payload;
                ...
                this.error = "Name has to be 12 alphanumeric characters (currently ".concat(this.payload.name.length, ")");
                return _context.abrupt("return");
              ...
              case 16:
                if (this.payloadFormState === 'system') {
                  if (this.payload.action == 's') {
                    _jsonData = {
                      Name: 'v1stake',
                      Args: []
                    };
                    payload = jsonPayload(_jsonData);
                  }
                  ...
                  stringPayload = JSON.stringify(_jsonData, undefined, 2);
                  type = 1;
                }
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return Object(timed_async__WEBPACK_IMPORTED_MODULE_4__["timedAsync"])(function () {
                  return Object(_utils_promisify__WEBPACK_IMPORTED_MODULE_1__["promisifySimple"])(_this2.$background.sendTransaction)(_this2.signedTx, _this2.signedTx.chainId);
                }, {
                  fastTime: 1000,
                  slowTime: 5000,
                  slow: function slow() {
                    _this2.slowQuery = true;
                  }
                });
...
/* harmony import */ var _components_PermissionRequest__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/PermissionRequest */ "./src/vue/components/PermissionRequest.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    PermissionRequest: _components_PermissionRequest__WEBPACK_IMPORTED_MODULE_5__["default"]
  }
});
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./../../../node_modules/buffer/index.js */ "./node_modules/buffer/index.js").Buffer))
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib/index.js?!./src/vue/components/PermissionRequest.vue?vue&type=style&index=0&lang=scss&":
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--2-2!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib??vue-loader-options!./src/vue/components/PermissionRequest.vue?vue&type=style&index=0&lang=scss& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/ApiTxSend.vue?vue&type=style&index=0&lang=scss&":
/*!*************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--2-2!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib??vue-loader-options!./src/vue/pages/ApiTxSend.vue?vue&type=style&index=0&lang=scss& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n.error {\n  color: red;\n}\n.tx-verify .identicon {\n  margin-right: 5px;\n  line-height: 1;\n}\n.tx-verify .identicon, .tx-verify .identicon svg {\n  width: 40px;\n  height: 40px;\n}\n.input-field {\n  width: 200px;\n  box-sizing: border-box;\n}\n.action-hint {\n  text-align: center;\n  color: #666;\n}\n.overlay-dialog h2 {\n  margin: 0 0 .5em;\n}\n.confirm-account {\n  display: flex;\n  align-items: center;\n}\n.confirm-account .address {\n    flex: 1;\n    text-align: left;\n}\n.dataConfirm {\n  text-align: left;\n  margin: 0 auto;\n  display: inline-block;\n}\n.icon-fromto {\n  display: inline-block;\n  background: url(" + escape(__webpack_require__(/*! @assets/img/icon-fromto-to.svg */ "./src/assets/img/icon-fromto-to.svg")) + ");\n  width: 24px;\n  height: 24px;\n  background-size: 100%;\n}\n", ""]);
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/ApiTxSign.vue?vue&type=style&index=0&lang=scss&":
/*!*************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--2-2!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib??vue-loader-options!./src/vue/pages/ApiTxSign.vue?vue&type=style&index=0&lang=scss& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/GetPublic.vue?vue&type=style&index=0&lang=scss&":
/*!*************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--2-2!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib??vue-loader-options!./src/vue/pages/GetPublic.vue?vue&type=style&index=0&lang=scss& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./src/vue/components/PermissionRequest.vue?vue&type=template&id=9a454eae&":
/*!***************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/vue/components/PermissionRequest.vue?vue&type=template&id=9a454eae& ***!
  \***************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "permission-request" }, [
    _vm._v("\n  The website at\n  "),
    _c("span", { staticClass: "url" }, [_vm._v(_vm._s(_vm.url))]),
    _vm._v(" wants to " + _vm._s(_vm.action) + "\n  "),
    _c("span", { staticClass: "object" }, [_vm._v(_vm._s(_vm.object))])
  ])
}
var staticRenderFns = []
render._withStripped = true
      ...
      [
        ...
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _c("span", [
              _vm.$route.params.address && _vm.$route.params.address !== "none"
                ? _c("span", { staticClass: "account-name" }, [
                    _vm._v("Account")
                  ])
                : _vm._e(),
              _vm._v(" "),
              _vm.$route.params.address === "none"
                ? _c("span", { staticClass: "account-name" }, [
      ...
      _c("div", { staticClass: "scroll-view" }, [
        _c(
          ...
          [
            ...
            _vm._v(" "),
            _vm._l(_vm.accountsByChainId, function(ref) {
              var chainId = ref[0]
              var accounts = ref[1]
              return [
                _c("li", { key: chainId, staticClass: "chainid-seperator" }, [
                  _c("span", { staticClass: "chain" }, [
                    _vm._v(_vm._s(chainId))
                  ])
                ]),
                _vm._v(" "),
                _vm._l(accounts, function(account) {
                  return _c(
                    "li",
                    {
                      key: account.key,
                      ...
                      _c(
                        "router-link",
                        {
                          attrs: {
                            to:
                              "/account/" +
                              encodeURIComponent(account.key) +
                              "/"
                          }
                        },
                        [
                            ...
                            [
                              ...
                              _c(
                                ...
                                [
                                  _c(
                                    "ul",
                                    { staticClass: "account-menu-items" },
                                    [
                                      _vm.explorerUrl(account)
                                        ? _c(
                                            "li",
                                            {
                                              on: {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/ApiTxSend.vue?vue&type=template&id=2c76772e&":
/*!**************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/vue/pages/ApiTxSend.vue?vue&type=template&id=2c76772e& ***!
  \**************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _vm.request.request
        ? _c("PermissionRequest", {
            attrs: {
              url: _vm.request.request.senderURL,
              action: "",
              object: "send a transaction"
            }
          })
        : _vm._e(),
      _vm._v(" "),
      _c("div", { staticStyle: { position: "relative" } }, [
            ...
            _vm.signedTx
              ? _c("p", [
                  ...
                  _vm.explorerLink
                    ? _c(
                        "a",
                        { attrs: { href: _vm.explorerLink, target: "_blank" } },
                        [_vm._v("Open in Aergoscan")]
                      )
                    : _vm._e()
                ])
              : _vm._e(),
        ...
        _c(
          ...
          [
            _vm.signedTx
              ? _c("div", { staticClass: "tx-verify" }, [
                  _c(
                    "span",
                    { staticClass: "confirm-account" },
                    [
                      _c("Identicon", { attrs: { text: _vm.address } }),
                      _vm._v(" "),
                      _c("span", { staticClass: "address" }, [
                  ...
                  _vm._v(" "),
                  _c("span", { staticClass: "icon-fromto" }),
                  _vm._v(" "),
                  _c("br"),
                  _vm._v(" "),
                  _c(
                    ...
                    { staticClass: "confirm-account" },
                    [
                      _c("Identicon", { attrs: { text: _vm.txData.to } }),
                      _vm._v(" "),
                      _c("span", { staticClass: "address" }, [
                        _vm._v(_vm._s(_vm.txData.to || "(Create Contract)"))
                      ])
                    ],
                    1
                  ),
                  _c("br"),
                  _vm._v("\n        Amount: "),
                  _c("strong", [_vm._v(_vm._s(_vm.txData.amount))]),
                  _vm._v(" "),
                  _vm.payloadDisplay && _vm.payloadDisplay.length
                    ? _c("div", [
                        _vm._v("\n          Data:\n          "),
                        _c("br"),
                        _vm._v(" "),
                        _c("pre", { staticClass: "dataConfirm" }, [
                          _vm._v(_vm._s(_vm.payloadDisplay))
                        ])
                      ])
                    : _vm._e()
                ])
        ...
        _c(
          "div",
          {
            ...
            class: {
              visible:
                !_vm.$route.params.address ||
                _vm.$route.params.address === "none"
            }
          },
          [
            _c("p", { staticClass: "error" }, [
              _vm._v("Please select an account before continuing.")
            ])
          ]
        )
      ])
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/ApiTxSign.vue?vue&type=template&id=9c0e9fc4&":
/*!**************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/vue/pages/ApiTxSign.vue?vue&type=template&id=9c0e9fc4& ***!
  \**************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
      ...
      _c("div", { staticStyle: { position: "relative" } }, [
        ...
        _c(
          ...
          [
            _c("span", { staticClass: "icon icon-success" }),
            _vm._v(" "),
            _c("h2", [_vm._v("The transaction has been signed.")]),
            _vm._v(" "),
            _vm.signedTx
              ? _c("p", [
                  _c("strong", [
                    _vm._v("Signature: " + _vm._s(_vm.lastTxSignature))
                  ]),
                  _c("br")
                ])
              : _vm._e(),
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/GetPublic.vue?vue&type=template&id=f8074b3c&":
/*!**************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./src/vue/pages/GetPublic.vue?vue&type=template&id=f8074b3c& ***!
  \**************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
    ...
    [
      _c("PermissionRequest", {
        attrs: {
          url: _vm.request.request.senderURL,
          action: "receive",
          object: "your active account's public address and chain id"
        }
      }),
      _vm._v(" "),
        ...
        [
          ...
          !_vm.initialized && !_vm.setupVisible
            ? _c("div", [
                ...
                _vm._v(" "),
                _c("h1", [_vm._v("Welcome to Aergo Connect.")]),
                _vm._v(" "),
                _c("p", [
                  _vm._v(
                    "A secure wallet to manage your Aergo accounts in the browser."
                  )
                ]),
                _vm._v(" "),
                _c(
...
var render = function() {
  ...
  return _c("div", { staticClass: "scroll-view" }, [
    ...
    _c(
      ...
      [
        _c("h2", [_vm._v("Do you confirm this transaction?")]),
        _vm._v(" "),
        _vm.signedTx
          ? _c("div", { staticClass: "tx-verify" }, [
              _c(
              ...
              _c("br"),
              _vm._v("\n      Amount: "),
              _c("strong", [_vm._v(_vm._s(_vm.signedTx.amount))]),
              _vm._v(" "),
              _vm.stringPayload && _vm.stringPayload.length
                ? _c("div", [
                    _vm._v("\n        Data:\n        "),
                    _c("br"),
                    _vm._v(" "),
                    _c("pre", { staticClass: "dataConfirm" }, [
                      _vm._v(_vm._s(_vm.stringPayload))
                    ])
                  ])
                : _vm._e()
            ])
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c(
        "form",
        { staticClass: "form sign-form", attrs: { autocomplete: "off" } },
        [
          _c("div", { staticClass: "form-line vertical" }, [
            _c("label", [
              _vm._v("\n        Message\n\n        "),
              !_vm.request || !_vm.request.request
                ? _c("textarea", {
                    directives: [
                      {
                        name: "model",
                    ...
                    attrs: { placeholder: "Enter hex string (0x...) or text" },
                    ...
                    directives: [
                      {
                        name: "model",
                        rawName: "v-model",
                        value: _vm.request.request.data.hash,
                        expression: "request.request.data.hash"
                      }
                    ],
                    staticClass: "text-input",
                    staticStyle: { height: "80px" },
                    attrs: { readonly: "" },
                    domProps: { value: _vm.request.request.data.hash },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib/index.js?!./src/vue/components/PermissionRequest.vue?vue&type=style&index=0&lang=scss&":
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-style-loader!./node_modules/css-loader!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--2-2!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib??vue-loader-options!./src/vue/components/PermissionRequest.vue?vue&type=style&index=0&lang=scss& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// load the styles
var content = __webpack_require__(/*! !../../../node_modules/css-loader!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/src??ref--2-2!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib??vue-loader-options!./PermissionRequest.vue?vue&type=style&index=0&lang=scss& */ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib/index.js?!./src/vue/components/PermissionRequest.vue?vue&type=style&index=0&lang=scss&");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__(/*! ../../../node_modules/vue-style-loader/lib/addStylesClient.js */ "./node_modules/vue-style-loader/lib/addStylesClient.js").default
var update = add("f998715c", content, false, {});
// Hot Module Replacement
if(false) {}
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/ApiTxSend.vue?vue&type=style&index=0&lang=scss&":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-style-loader!./node_modules/css-loader!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--2-2!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib??vue-loader-options!./src/vue/pages/ApiTxSend.vue?vue&type=style&index=0&lang=scss& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// load the styles
var content = __webpack_require__(/*! !../../../node_modules/css-loader!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/src??ref--2-2!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib??vue-loader-options!./ApiTxSend.vue?vue&type=style&index=0&lang=scss& */ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/ApiTxSend.vue?vue&type=style&index=0&lang=scss&");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__(/*! ../../../node_modules/vue-style-loader/lib/addStylesClient.js */ "./node_modules/vue-style-loader/lib/addStylesClient.js").default
var update = add("cf4e8f74", content, false, {});
// Hot Module Replacement
if(false) {}

/***/ }),

/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/ApiTxSign.vue?vue&type=style&index=0&lang=scss&":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-style-loader!./node_modules/css-loader!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--2-2!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib??vue-loader-options!./src/vue/pages/ApiTxSign.vue?vue&type=style&index=0&lang=scss& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// load the styles
var content = __webpack_require__(/*! !../../../node_modules/css-loader!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/src??ref--2-2!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib??vue-loader-options!./ApiTxSign.vue?vue&type=style&index=0&lang=scss& */ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/ApiTxSign.vue?vue&type=style&index=0&lang=scss&");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__(/*! ../../../node_modules/vue-style-loader/lib/addStylesClient.js */ "./node_modules/vue-style-loader/lib/addStylesClient.js").default
var update = add("3ca58530", content, false, {});
// Hot Module Replacement
if(false) {}
...
/***/ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/GetPublic.vue?vue&type=style&index=0&lang=scss&":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-style-loader!./node_modules/css-loader!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--2-2!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib??vue-loader-options!./src/vue/pages/GetPublic.vue?vue&type=style&index=0&lang=scss& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// load the styles
var content = __webpack_require__(/*! !../../../node_modules/css-loader!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/src??ref--2-2!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib??vue-loader-options!./GetPublic.vue?vue&type=style&index=0&lang=scss& */ "./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/GetPublic.vue?vue&type=style&index=0&lang=scss&");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var add = __webpack_require__(/*! ../../../node_modules/vue-style-loader/lib/addStylesClient.js */ "./node_modules/vue-style-loader/lib/addStylesClient.js").default
var update = add("5bbc1090", content, false, {});
// Hot Module Replacement
if(false) {}
...
module.exports = "data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIyNCIgaGVpZ2h0PSIyNCI+PHBhdGggZmlsbD0ibm9uZSIgc3Ryb2tlPSIjRjczQUE5IiBkPSJNMTUgNmwtNiA2IDYgNiIvPjwvc3ZnPg=="

/***/ }),

/***/ "./src/assets/img/icon-fromto-to.svg":
/*!*******************************************!*\
  !*** ./src/assets/img/icon-fromto-to.svg ***!
  \*******************************************/
/*! no static exports found */
...
module.exports = "data:image/svg+xml;base64,"
...
module.exports = "data:image/svg+xml;base64,"
...
function chainProvider(chainId) {
  ...
  if (typeof chainConfig === 'undefined') return {
    ...
    explorerUrl: function explorerUrl() {
      return '';
    }
  };
  return {
...
/***/ "./src/vue/components/PermissionRequest.vue":
/*!**************************************************!*\
  !*** ./src/vue/components/PermissionRequest.vue ***!
  \**************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _PermissionRequest_vue_vue_type_template_id_9a454eae___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./PermissionRequest.vue?vue&type=template&id=9a454eae& */ "./src/vue/components/PermissionRequest.vue?vue&type=template&id=9a454eae&");
/* harmony import */ var _PermissionRequest_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./PermissionRequest.vue?vue&type=script&lang=js& */ "./src/vue/components/PermissionRequest.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _PermissionRequest_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./PermissionRequest.vue?vue&type=style&index=0&lang=scss& */ "./src/vue/components/PermissionRequest.vue?vue&type=style&index=0&lang=scss&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _PermissionRequest_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _PermissionRequest_vue_vue_type_template_id_9a454eae___WEBPACK_IMPORTED_MODULE_0__["render"],
  _PermissionRequest_vue_vue_type_template_id_9a454eae___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "src/vue/components/PermissionRequest.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./src/vue/components/PermissionRequest.vue?vue&type=script&lang=js&":
/*!***************************************************************************!*\
  !*** ./src/vue/components/PermissionRequest.vue?vue&type=script&lang=js& ***!
  \***************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_PermissionRequest_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--1-0!../../../node_modules/vue-loader/lib??vue-loader-options!./PermissionRequest.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./src/vue/components/PermissionRequest.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_PermissionRequest_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./src/vue/components/PermissionRequest.vue?vue&type=style&index=0&lang=scss&":
/*!************************************************************************************!*\
  !*** ./src/vue/components/PermissionRequest.vue?vue&type=style&index=0&lang=scss& ***!
  \************************************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_PermissionRequest_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-style-loader!../../../node_modules/css-loader!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/src??ref--2-2!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib??vue-loader-options!./PermissionRequest.vue?vue&type=style&index=0&lang=scss& */ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib/index.js?!./src/vue/components/PermissionRequest.vue?vue&type=style&index=0&lang=scss&");
/* harmony import */ var _node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_PermissionRequest_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_PermissionRequest_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_PermissionRequest_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_PermissionRequest_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_PermissionRequest_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default.a); 

/***/ }),

/***/ "./src/vue/components/PermissionRequest.vue?vue&type=template&id=9a454eae&":
/*!*********************************************************************************!*\
  !*** ./src/vue/components/PermissionRequest.vue?vue&type=template&id=9a454eae& ***!
  \*********************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_PermissionRequest_vue_vue_type_template_id_9a454eae___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./PermissionRequest.vue?vue&type=template&id=9a454eae& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./src/vue/components/PermissionRequest.vue?vue&type=template&id=9a454eae&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_PermissionRequest_vue_vue_type_template_id_9a454eae___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_PermissionRequest_vue_vue_type_template_id_9a454eae___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ApiTxSend_vue_vue_type_template_id_2c76772e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ApiTxSend.vue?vue&type=template&id=2c76772e& */ "./src/vue/pages/ApiTxSend.vue?vue&type=template&id=2c76772e&");
/* harmony import */ var _ApiTxSend_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ApiTxSend.vue?vue&type=script&lang=js& */ "./src/vue/pages/ApiTxSend.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _ApiTxSend_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ApiTxSend.vue?vue&type=style&index=0&lang=scss& */ "./src/vue/pages/ApiTxSend.vue?vue&type=style&index=0&lang=scss&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _ApiTxSend_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _ApiTxSend_vue_vue_type_template_id_2c76772e___WEBPACK_IMPORTED_MODULE_0__["render"],
  _ApiTxSend_vue_vue_type_template_id_2c76772e___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "src/vue/pages/ApiTxSend.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./src/vue/pages/ApiTxSend.vue?vue&type=script&lang=js&":
/*!**************************************************************!*\
  !*** ./src/vue/pages/ApiTxSend.vue?vue&type=script&lang=js& ***!
  \**************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiTxSend_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--1-0!../../../node_modules/vue-loader/lib??vue-loader-options!./ApiTxSend.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/ApiTxSend.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiTxSend_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./src/vue/pages/ApiTxSend.vue?vue&type=style&index=0&lang=scss&":
/*!***********************************************************************!*\
  !*** ./src/vue/pages/ApiTxSend.vue?vue&type=style&index=0&lang=scss& ***!
  \***********************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiTxSend_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-style-loader!../../../node_modules/css-loader!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/src??ref--2-2!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib??vue-loader-options!./ApiTxSend.vue?vue&type=style&index=0&lang=scss& */ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/ApiTxSend.vue?vue&type=style&index=0&lang=scss&");
/* harmony import */ var _node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiTxSend_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiTxSend_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiTxSend_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiTxSend_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiTxSend_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default.a); 

/***/ }),

/***/ "./src/vue/pages/ApiTxSend.vue?vue&type=template&id=2c76772e&":
/*!********************************************************************!*\
  !*** ./src/vue/pages/ApiTxSend.vue?vue&type=template&id=2c76772e& ***!
  \********************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiTxSend_vue_vue_type_template_id_2c76772e___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./ApiTxSend.vue?vue&type=template&id=2c76772e& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/ApiTxSend.vue?vue&type=template&id=2c76772e&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiTxSend_vue_vue_type_template_id_2c76772e___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiTxSend_vue_vue_type_template_id_2c76772e___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./src/vue/pages/ApiTxSign.vue":
/*!*************************************!*\
  !*** ./src/vue/pages/ApiTxSign.vue ***!
  \*************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ApiTxSign_vue_vue_type_template_id_9c0e9fc4___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ApiTxSign.vue?vue&type=template&id=9c0e9fc4& */ "./src/vue/pages/ApiTxSign.vue?vue&type=template&id=9c0e9fc4&");
/* harmony import */ var _ApiTxSign_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ApiTxSign.vue?vue&type=script&lang=js& */ "./src/vue/pages/ApiTxSign.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _ApiTxSign_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ApiTxSign.vue?vue&type=style&index=0&lang=scss& */ "./src/vue/pages/ApiTxSign.vue?vue&type=style&index=0&lang=scss&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _ApiTxSign_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _ApiTxSign_vue_vue_type_template_id_9c0e9fc4___WEBPACK_IMPORTED_MODULE_0__["render"],
  _ApiTxSign_vue_vue_type_template_id_9c0e9fc4___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "src/vue/pages/ApiTxSign.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./src/vue/pages/ApiTxSign.vue?vue&type=script&lang=js&":
/*!**************************************************************!*\
  !*** ./src/vue/pages/ApiTxSign.vue?vue&type=script&lang=js& ***!
  \**************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiTxSign_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--1-0!../../../node_modules/vue-loader/lib??vue-loader-options!./ApiTxSign.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/ApiTxSign.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiTxSign_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./src/vue/pages/ApiTxSign.vue?vue&type=style&index=0&lang=scss&":
/*!***********************************************************************!*\
  !*** ./src/vue/pages/ApiTxSign.vue?vue&type=style&index=0&lang=scss& ***!
  \***********************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiTxSign_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-style-loader!../../../node_modules/css-loader!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/src??ref--2-2!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib??vue-loader-options!./ApiTxSign.vue?vue&type=style&index=0&lang=scss& */ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/ApiTxSign.vue?vue&type=style&index=0&lang=scss&");
/* harmony import */ var _node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiTxSign_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiTxSign_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiTxSign_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiTxSign_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiTxSign_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default.a); 

/***/ }),

/***/ "./src/vue/pages/ApiTxSign.vue?vue&type=template&id=9c0e9fc4&":
/*!********************************************************************!*\
  !*** ./src/vue/pages/ApiTxSign.vue?vue&type=template&id=9c0e9fc4& ***!
  \********************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiTxSign_vue_vue_type_template_id_9c0e9fc4___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./ApiTxSign.vue?vue&type=template&id=9c0e9fc4& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/ApiTxSign.vue?vue&type=template&id=9c0e9fc4&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiTxSign_vue_vue_type_template_id_9c0e9fc4___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiTxSign_vue_vue_type_template_id_9c0e9fc4___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _GetPublic_vue_vue_type_template_id_f8074b3c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./GetPublic.vue?vue&type=template&id=f8074b3c& */ "./src/vue/pages/GetPublic.vue?vue&type=template&id=f8074b3c&");
/* harmony import */ var _GetPublic_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./GetPublic.vue?vue&type=script&lang=js& */ "./src/vue/pages/GetPublic.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _GetPublic_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./GetPublic.vue?vue&type=style&index=0&lang=scss& */ "./src/vue/pages/GetPublic.vue?vue&type=style&index=0&lang=scss&");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _GetPublic_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _GetPublic_vue_vue_type_template_id_f8074b3c___WEBPACK_IMPORTED_MODULE_0__["render"],
  _GetPublic_vue_vue_type_template_id_f8074b3c___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "src/vue/pages/GetPublic.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./src/vue/pages/GetPublic.vue?vue&type=script&lang=js&":
/*!**************************************************************!*\
  !*** ./src/vue/pages/GetPublic.vue?vue&type=script&lang=js& ***!
  \**************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_GetPublic_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--1-0!../../../node_modules/vue-loader/lib??vue-loader-options!./GetPublic.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/GetPublic.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_GetPublic_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./src/vue/pages/GetPublic.vue?vue&type=style&index=0&lang=scss&":
/*!***********************************************************************!*\
  !*** ./src/vue/pages/GetPublic.vue?vue&type=style&index=0&lang=scss& ***!
  \***********************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_GetPublic_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-style-loader!../../../node_modules/css-loader!../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../node_modules/postcss-loader/src??ref--2-2!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib??vue-loader-options!./GetPublic.vue?vue&type=style&index=0&lang=scss& */ "./node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/lib/loader.js!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/GetPublic.vue?vue&type=style&index=0&lang=scss&");
/* harmony import */ var _node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_GetPublic_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_GetPublic_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_GetPublic_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_GetPublic_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_2_2_node_modules_sass_loader_lib_loader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_GetPublic_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default.a); 

/***/ }),

/***/ "./src/vue/pages/GetPublic.vue?vue&type=template&id=f8074b3c&":
/*!********************************************************************!*\
  !*** ./src/vue/pages/GetPublic.vue?vue&type=template&id=f8074b3c& ***!
  \********************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_GetPublic_vue_vue_type_template_id_f8074b3c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./GetPublic.vue?vue&type=template&id=f8074b3c& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./src/vue/pages/GetPublic.vue?vue&type=template&id=f8074b3c&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_GetPublic_vue_vue_type_template_id_f8074b3c___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_GetPublic_vue_vue_type_template_id_f8074b3c___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
/* harmony import */ var _vue_pages_ApiTxSend_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../vue/pages/ApiTxSend.vue */ "./src/vue/pages/ApiTxSend.vue");
/* harmony import */ var _vue_pages_ApiTxSign_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../vue/pages/ApiTxSign.vue */ "./src/vue/pages/ApiTxSign.vue");
/* harmony import */ var _vue_pages_History_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../vue/pages/History.vue */ "./src/vue/pages/History.vue");
/* harmony import */ var _vue_pages_AddAccount_vue__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../vue/pages/AddAccount.vue */ "./src/vue/pages/AddAccount.vue");
/* harmony import */ var _vue_pages_CreateAccount_vue__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../vue/pages/CreateAccount.vue */ "./src/vue/pages/CreateAccount.vue");
/* harmony import */ var _vue_pages_ImportAccount_vue__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../vue/pages/ImportAccount.vue */ "./src/vue/pages/ImportAccount.vue");
/* harmony import */ var _vue_pages_Reset_vue__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../vue/pages/Reset.vue */ "./src/vue/pages/Reset.vue");
/* harmony import */ var _vue_pages_ExportAccount_vue__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../vue/pages/ExportAccount.vue */ "./src/vue/pages/ExportAccount.vue");
/* harmony import */ var _vue_pages_RemoveAccount_vue__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../vue/pages/RemoveAccount.vue */ "./src/vue/pages/RemoveAccount.vue");
/* harmony import */ var _vue_pages_GetPublic_vue__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../vue/pages/GetPublic.vue */ "./src/vue/pages/GetPublic.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ([{
  ...
  path: '/reset',
  component: _vue_pages_Reset_vue__WEBPACK_IMPORTED_MODULE_12__["default"],
  meta: {
    transitionName: 'fade'
  }
}, {
  ...
  path: '/add-account/',
  component: _vue_pages_AddAccount_vue__WEBPACK_IMPORTED_MODULE_9__["default"],
  meta: {
    transitionName: 'slide-vertical'
  }
}, {
  path: '/add-account/create/',
  component: _vue_pages_CreateAccount_vue__WEBPACK_IMPORTED_MODULE_10__["default"],
  meta: {
    transitionName: 'slide-vertical'
  }
}, {
  path: '/add-account/import/',
  component: _vue_pages_ImportAccount_vue__WEBPACK_IMPORTED_MODULE_11__["default"],
  meta: {
    transitionName: 'slide-vertical'
  }
}, {
  ...
  children: [{
    ...
    path: 'api-tx-send',
    name: 'tx_send',
    component: _vue_pages_ApiTxSend_vue__WEBPACK_IMPORTED_MODULE_6__["default"],
    meta: {
      transitionName: 'slide',
      index: 2
    }
    ...
    path: 'api-tx-sign',
    name: 'tx_sign',
    component: _vue_pages_ApiTxSign_vue__WEBPACK_IMPORTED_MODULE_7__["default"],
    meta: {
      transitionName: 'slide',
      index: 2
    }
    ...
    path: 'history',
    component: _vue_pages_History_vue__WEBPACK_IMPORTED_MODULE_8__["default"],
    meta: {
      transitionName: 'slide',
      index: 4
    }
    ...
    path: 'api-public',
    name: 'account_public',
    component: _vue_pages_GetPublic_vue__WEBPACK_IMPORTED_MODULE_15__["default"],
    meta: {
      transitionName: 'slide',
      donottrack: true
    }
    ...
    path: 'export',
    component: _vue_pages_ExportAccount_vue__WEBPACK_IMPORTED_MODULE_13__["default"],
    meta: {
      transitionName: 'slide',
      donottrack: true
    }
    ...
    path: 'remove',
    component: _vue_pages_RemoveAccount_vue__WEBPACK_IMPORTED_MODULE_14__["default"],
    meta: {
      transitionName: 'slide',
      donottrack: true
    }
...
/* harmony import */ var _utils_promisify__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../utils/promisify */ "./src/utils/promisify.js");
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
...
var createRouter = function createRouter(routes, store, gotoRoute) {
  ...
  router.beforeEach(function (to, from, next) {
    ...
    if (to.fullPath == '/' && initialLoad || to.name == 'deposit' && gotoRoute) {
      initialLoad = false; // Update address of request route

      if (gotoRoute && to.params && to.params.address) {
        gotoRoute.params.address = to.params.address;
      }

      var savedPath = gotoRoute || store.state.navigation.currentPath;
    ...
    if (to.params.address) {
      try {
        var _to$params$address$sp = to.params.address.split('/'),
            _to$params$address$sp2 = _slicedToArray(_to$params$address$sp, 2),
            chainId = _to$params$address$sp2[0],
            address = _to$params$address$sp2[1];

        store.dispatch('navigation/setActiveAccount', {
          chainId: chainId,
          address: address
        });
      } catch (e) {
...
function getRequestId() {
  ...
  var requestId = urlParams.get('request');
  return requestId;
}

function handlePermissionRequest(_x) {
  return _handlePermissionRequest.apply(this, arguments);
}

function _handlePermissionRequest() {
  _handlePermissionRequest = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(background) {
    var activeAccount, requestId, name, request, requestTypeToRoute;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return Object(_utils_promisify__WEBPACK_IMPORTED_MODULE_12__["promisifySimple"])(background.getActiveAccount)();
          ...
          case 2:
            ...
            _context.next = 9;
            return Object(_utils_promisify__WEBPACK_IMPORTED_MODULE_12__["promisifySimple"])(background.getPermissionRequestData)(requestId);

          case 9:
            request = _context.sent;
            console.log(request);
            _store_index__WEBPACK_IMPORTED_MODULE_5__["default"].dispatch('navigation/setActiveRequest', {
              requestId: requestId,
              request: request
            });
            requestTypeToRoute = {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 10;
            return handlePermissionRequest(opts.background);

          case 10:
            gotoRoute = _context2.sent;
            router = createRouter(_routes__WEBPACK_IMPORTED_MODULE_3__["default"], _store_index__WEBPACK_IMPORTED_MODULE_5__["default"], gotoRoute);
...
var actions = {
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              Object(_utils_promisify__WEBPACK_IMPORTED_MODULE_0__["promisifySimple"])(this._vm.$background.setActiveAccount)({
                address: address,
                chainId: chainId
              });
              _context5.next = 5;
  ...
  addNetwork: function () {
    ...
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee7(_ref12, _ref13) {
      var chainId, nodeUrl;
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              chainId = _ref13.chainId, nodeUrl = _ref13.nodeUrl;
              _context7.next = 4;
              return Object(_utils_promisify__WEBPACK_IMPORTED_MODULE_0__["promisifySimple"])(this._vm.$background.addNetwork)({
                chainId: chainId,
                nodeUrl: nodeUrl
              });
    ...
    return function addNetwork(_x12, _x13) {
...
var mutations = {
  ...
  setAccountTxs: function setAccountTxs(state, _ref14) {
...
var actions = {
  ...
  setActiveAccount: function setActiveAccount(_ref2, address) {
    var commit = _ref2.commit;
    commit('setActiveAccount', address);
  },
  setActiveRequest: function setActiveRequest(_ref3, _ref4) {
    var commit = _ref3.commit;
    var requestId = _ref4.requestId,
        request = _ref4.request;
    commit('setActiveRequest', {
      requestId: requestId,
      request: request
    });
  }
...
var mutations = {
  ...
  setActiveAccount: function setActiveAccount(state, address) {
    if (address === state.activeAccount) return;
    state.activeAccount = address;
  },
  setActiveRequest: function setActiveRequest(state, request) {
